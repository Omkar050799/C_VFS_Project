...
#define END 2
 ...
 //////////////////////////////////////////////////////////////////////////////
//CREATED STRUCTURE FOR SUPERBLOCK
/////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
//CREATING STRUCTURE FOR FILETABLE 
////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
//CREATING STRUCTURE FOR USER FILE DISCRIPTER TABLE
/////////////////////////////////////////////////////////////////////
   typedef struct ufdt
    {
    ...
    void man(char *name)
     {
        ...
        if(strcmp(name,"create") == 0)
          {
            printf("Description : Used to create new reguler file \n");
          ...
          {
            printf("Description : used to displat information of file\n");
          ...
          {
            printf("Description : Used to close openrd file\n");
            ...
            if(count == 1)
             {
                    if(strcmp(command[0],"ls") == 0)
                      ...
                      {
                          CLoseAllFile();
                          printf("All file closed successfull\n");
                          continue;
                      }  
                  ...
                  if(strcmp(command[0],"stat") == 0)
                  ...
                  else if(strcmp(command[0],"write") == 0)
                    {
                         ...
                         if(fd == -1)
                           ...
                           if(ret == -2)
                                  printf("ERROR : There is no sufficient memory to writen\n");
                           if(ret == -3)
                  ...
                  {  
                ...
                else if(strcmp(command[0],"read") == 0)
                   {
                      ...
                      if(fd == -1)
                       ...
                       if(ptr == NULL)
                         {
                            printf("ERROR : Memmory allocation failuer\n");
                            continue;
                         }
